        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="ourForm" method="POST" action="{{ route('register') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="invite" class="col-md-4 col-form-label text-md-right">Фамилия пригласившего</label>

                                <div class="col-md-6">
                                    <select class="form-control" id="invite" name="invite" required autocomplete="invite">
                                        <option disabled>Выберите пригласившего вас пользователя</option>
